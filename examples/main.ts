...
define(['localforage', '../dist/localforage-getitems'], function (localforage, getItems) {
    var driverTestOrder = [localforage.WEBSQL, localforage.INDEXEDDB, localforage.LOCALSTORAGE];
    ...
    localforage
        ...
        .then(function (keys) {
            ...
            var itemKeys = ['user-1-todo-4', 'user-1-todo-3', 'user-2-todo-2', 'user-2-todo-1'];
